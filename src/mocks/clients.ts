...
export const clients: Client[] = [
  ...
  {
    id: "cli-bettina-ocampo",
    companyId: "firm-advench",
    name: "Bettina Ocampo",
    contactNumber: "0928-666-7788",
    email: "bettina.ocampo@example.com",
    employmentStatus: "OFW",
    propertyId: "prop-centralpark-5d",
    consultantId: "cons-adv-sp3",
    saleType: "Referred",
    paymentMethod: "Bank Financing",
    ...
    lastContactedDate: "2026-07-24",
    notes: "First tranche reached — Basic-phase documents cleared before RS.",
    requirementsChecklist: [
      {
        id: "req-bettina-1",
        label: "2 valid government IDs",
  ...
  {
    id: "cli-danilo-pascual",
    companyId: "firm-advench",
    name: "Danilo Pascual",
    contactNumber: "0929-777-8899",
    email: "danilo.pascual@example.com",
    employmentStatus: "Self-Employed",
    propertyId: "prop-brookside-lot9",
    consultantId: "cons-adv-sm2",
    saleType: "Direct",
    paymentMethod: "Cash",
    ...
    notes: "Closed directly by the Sales Manager — full cash payment on RS.",
    requirementsChecklist: [
      {
        id: "req-danilo-1",
        label: "Valid government ID",
        phase: "Basic",
        checked: true,
        verifiedBy: "Rolando Cruz Mercado",
        verifiedDate: "2026-07-05",
      },
      {
        id: "req-danilo-2",
  ...
  {
    id: "cli-precious-ibarra",
    companyId: "firm-advench",
    name: "Precious Ibarra",
    contactNumber: "0930-888-9900",
    email: "precious.ibarra@example.com",
    employmentStatus: "Locally Employed",
    ...
    lastContactedDate: "2026-07-22",
    notes: "Individual Seller listing — no developer commission structure attached.",
    requirementsChecklist: [
      {
        id: "req-precious-1",
        label: "Proof of income",
